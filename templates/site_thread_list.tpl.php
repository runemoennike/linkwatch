...
<?php foreach($threads as $thread) :
	...
	<li>
		...
		<?php echo interface_link('Remove', array('page' => 'threadmgmt', 'action' => 'delete', 'site_name' => $site['name'], 'thread_url' => urlencode($thread['url']), 'thread_title' => urlencode($thread['title']))); ?>) 
